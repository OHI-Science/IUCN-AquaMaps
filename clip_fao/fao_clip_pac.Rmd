...
``` {r quad_spp_w, echo = FALSE, warning = FALSE, message = FALSE, eval = TRUE}
...
spp_quad_list <- read_csv(file.path(dir_data, 'spp_list_quads.csv'))
...
head(spp_area_df)
#                                     am_sid    cellarea   oceanarea reviewed occurcells                   sciname
#                                      <chr>       <dbl>       <dbl>    <chr>      <int>                     <chr>
# 1                                Biv-32126   949988.02   642706.64     null          4        Corbicula japonica
# 2                                Biv-32832  9698932.54  7589672.98     null         23          Polymesoda erosa
# 3                               Bra-235673    16143.75    13895.96        1         10       Dyscritosia secreta
# 4 Chn-013ca97e-46a8-4c5e-b398-8bb4f340f88b 11288439.81 10048833.94     null         76          Lenisquilla lata
# 5 Chn-015453c0-3ff9-477d-ab51-c68d85e65af5 15078672.39 12760166.60     null         13        Clorida albolitura
# 6 Chn-0721ac0c-7d19-46fa-9dcc-02da54310867 35256268.05 33846838.22     null         23 Leiogalathea laevirostris
...
spp_area_clipped <- spp_area_df %>%
  filter(am_sid %in% clipped_spp$am_sid)
...
#                                              ordered = TRUE))
# 
# clipped_spp_quads <- clipped_spp_quads %>%
#   left_join(quad_names, by = 'quad') %>%
#   mutate(method = 'FAO clipped')
# 
# break_nums <- seq(0, 100, 20)

### Plot the bar chart
# barchart_clipped_spp_quads <- ggplot(clipped_spp_quads, 
...
#        fill = 'Alignment')
# 
# print(barchart_clipped_spp_quads)
