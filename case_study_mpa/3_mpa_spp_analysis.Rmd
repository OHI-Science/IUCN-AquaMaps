...
dir_am_data <- file.path(dir_N, 'git-annex/globalprep/_raw_data/aquamaps/d2015/csv')
...
barchart_mpa_gap <- ggplot(mpa_all_runs1, 
  ...
  scale_fill_manual(values = c('>10%'  = '#4dac26', 
                               ...
                               '0-2%'  = '#f1b6da',
                               'gap'   = '#d01c8b')) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 125), breaks = c(seq(0, 100, 20))) +
...
ggsave(plot = barchart_mpa_gap,
       filename = file.path(dir_fig, 'fig4_barchart_mpa_gap.png'),
       width = 11.4, height = 5, units = 'cm', dpi = 600)
ggsave(plot = barchart_mpa_gap,
       filename = file.path(dir_fig, 'fig4_barchart_mpa_gap.tif'), device = 'tiff',
       width = 11.4, height = 5, units = 'cm', dpi = 600)
