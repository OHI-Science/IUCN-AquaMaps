...
=======
___short paragraph about other datasets we didn't include, i.e. SAUP? BOTW?___
>>>>>>> 5f51740e3782c4ed0d29b291b8630808a2418470
...
<<<<<<< HEAD
_To highlight the differences in the datasets, we recalculated the OHI SPP status values using only one complete dataset at a time.  For the AquaMaps dataset, we used a presence threshold of 0% to align with the OHI 2016 assessment.  Note that the OHI 2016 analysis includes the Birds of the World dataset in addition to IUCN and AquaMaps; we excluded it for our analysis._ ___Fig. 3 compares these single-dataset scores to the 2016 OHI SPP status values.___
=======
