...
Noting that a large proportion of corals were identified in the upper-left quadrant, we examined a handful of IUCN coral maps and found that each predicted coral presence in far deeper waters than would be expected based on the IUCN's habitat description.  Using the IUCN's API [REF] to find life history information for all IUCN-mapped corals, we found that none of the paired-map corals is described as occurring deeper than 200 m, ___and most are found in far shallower waters.___  We created a 200 m bathymetry raster from Natural Earth's 200 m bathymetry polygon [@natural_earth_XXX] and masked our IUCN coral rasters to exclude presence below 200 m.  The resulting maps were again compared to the AquaMaps rasters; ___figure XXXX___ plots shifts in coral species alignment due to this depth clipping. ___does some of this belong in the results/discussion?___
