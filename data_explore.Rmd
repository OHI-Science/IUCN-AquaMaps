...
spp_gp_quadrants <- spp_gp_q1 %>%
  full_join(spp_gp_q2, by = c('spp_group', 'n_spp')) %>%
  full_join(spp_gp_q3, by = c('spp_group', 'n_spp')) %>%
  full_join(spp_gp_q4, by = c('spp_group', 'n_spp')) %>%
...
spp_gp_quadrants <- spp_gp_quadrants %>%
  left_join(spp_gp_quadrants %>% 
              filter(quad == 'q1') %>%
              dplyr::select(spp_group, pct_q1 = pct_quad),
            by = 'spp_group') %>%
