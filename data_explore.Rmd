...
ggsave('AreavsPercOverlap_log.png',width=6,height=4)
...
Looking at how many and what type (threat category) of species we are losing by setting a threshold of 0.4 on the aquamaps species.

```{r aquamaps probabilities, warning=F,message=F,cache.lazy=FALSE,cache=T,verbose=F,results=F,echo=F}
