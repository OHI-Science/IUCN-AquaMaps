...
>  __Fig. 1.__ (A) Number and proportion of species by taxa included in each dataset.  Overlapping species are dominated by bony fishes (`r n_bonyfish` species, primarily tropical taxa) and corals (`r n_corals` species).  
...
>  __Fig. 2.__(A, B) Number of global marine species according to (A) AquaMaps and (B) IUCN.  The margin frequency plots show relative species count per cell at each latitude and longitude. 
...
> __Fig. 4.__ Change in status score for the Species Subgoal within the global Ocean Health Index under three different scenarios.
