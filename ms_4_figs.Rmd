...
> __Fig. 2.__ (A) DESCRIPTION, then explanation... The upper right quadrant (quadrant 1) comprises species whose maps largely agree (better than median value) in both spatial distribution and the extent of described ranges
...
(B) Spatial alignment of paired-map species by taxonomic group. _is it distracting to use order names for some groups and not others?  Some of the groups had pretty long names ("acanthuridae" is way shorter than "surgeonfish, tangs, and unicornfish")_
