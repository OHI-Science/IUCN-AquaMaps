...
ggsave(file.path(dir_fig, 'AMThreshold.png'), width = 6, height = 3.5)
```
...
ggsave(file.path(dir_fig, 'AMThreshold2.png'), width = 6, height = 3.5)
...
ggsave(file.path(dir_fig, 'scatter_AMThreshold.png'), width = 6, height = 3.5)
...
ggsave(file.path(dir_fig, 'ribbon_AMThreshold.png'), width = 6, height = 3.5)
