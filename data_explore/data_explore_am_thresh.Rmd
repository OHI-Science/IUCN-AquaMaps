...
hist_area_vs_threshold <- ggplot(spp_df3, aes(prop, fill = iucn_code)) + 
  ...
  geom_vline(x = spp_df3_mean, color = 'darkred', linetype = 'dashed') + 
  annotate('text', x = spp_df3_mean, y = .16, hjust = 0, vjust = -.5,
           angle = 90, size = 2, color = 'grey20',
           label = 'mean') + 
  geom_vline(x = spp_df3_med, color = 'grey30', linetype = 'dashed') + 
...
ggsave(file.path(dir_fig, 'AMThreshold.png'), width = 6, height = 4)
```
...
hist_area_vs_threshold2 <- ggplot(spp_df3a, aes(prop, fill = iucn_code)) + 
  ggtheme_plot + 
  geom_histogram(aes(y = ..count../sum(..count..)), binwidth = 0.05, alpha = .7) + 
  geom_vline(x = spp_df3a_mean, color = 'darkred', linetype = 'dashed') + 
  annotate('text', x = spp_df3a_mean, y = .16, hjust = 0, vjust = -.5,
           angle = 90, size = 2, color = 'grey20',
           label = 'mean') + 
  geom_vline(x = spp_df3a_med, color = 'grey30', linetype = 'dashed') + 
...
ggsave(file.path(dir_fig, 'AMThreshold2.png'), width = 6, height = 4)
...
ggsave(file.path(dir_fig, 'scatter_AMThreshold.png'), width = 6, height = 4)
...
#  geom_point(position = position_jitter(w = .1), aes(color = scenario), alpha = .5) +
  ...
  geom_abline(intercept = area_mean_model[['coefficients']][1],
              ...
              color = 'red') + 
  geom_vline(x = 0.40, color = 'blue', linetype = 'dashed') +
  geom_vline(x = 0.50, color = 'blue', linetype = 'dashed') +
  geom_vline(x = 0.60, color = 'blue', linetype = 'dashed') +
...
ggsave(file.path(dir_fig, 'ribbon_AMThreshold.png'), width = 6, height = 4)
