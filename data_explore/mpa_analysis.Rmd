...
rast_marine_file <- file.path(dir_anx, 'explore_am_v_iucn/mpa_rasters/rast_marine.tif')
reload <- FALSE
if(reload == TRUE) {
### import OHI regions polygons, to determine spatially-marine areas
  poly_marine_file <- file.path(dir_anx, 'explore_am_v_iucn/mpa_rasters/poly_marine.shp')
