...
am_levelplot1 <- levelplot(all_am_map, par.settings = myTheme, main = 'Entire Aquamaps Dataset')
...
iucn_levelplot1 <- levelplot(all_iucn_map, par.settings = myTheme, main = 'Entire IUCN Dataset')
