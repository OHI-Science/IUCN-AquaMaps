...
am_levelplot1 <- levelplot(all_am_map, main = 'Entire Aquamaps Dataset') # add in par.settings = myTheme
...
iucn_levelplot1 <- levelplot(all_iucn_map, main = 'Entire IUCN Dataset') # add in par.settings = myTheme
