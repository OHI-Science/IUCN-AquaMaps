...
taxa_df_long2 <- taxa_df %>%
  ...
  mutate(n_total = sum(n_spp, na.rm = TRUE),
         ...
         dataset = factor(dataset, levels = c('Both', 'IUCN', 'AquaMaps')))
...
#  scale_fill_manual(values = c('AquaMaps' = 'red', 'Both' = 'mediumorchid', 'IUCN' = 'blue')) +
 scale_fill_manual(values = c('AquaMaps' = '#1b9e77', 'Both' = '#565080', 'IUCN' = '#d95f02')) +
#  scale_fill_manual(values = c('AquaMaps' = '#4dac26', 'Both' = '#fbe5c5', 'IUCN' = '#d01c8b')) +
