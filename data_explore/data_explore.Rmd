...
spp_list <- spp_list %>%
  left_join(read.csv('data/sciname_lookups/spp_groupnames.csv', stringsAsFactors = FALSE),
            by = 'spp_group')
...
sciname_lookup <- read.csv('data/sciname_lookups/spp_iucn_all.csv', stringsAsFactors = FALSE)
