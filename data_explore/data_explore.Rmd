...
setwd('data_explore') 
  ### When knitting, it automatically sets WD to be this directory...
  ### this command is just here to facilitate running when not in knit mode.
...
scatter_arearatio_vs_overlap <- scatter_arearatio_vs_overlap +
  labs(x = bquote('Area alignment '*alpha['area']*' (%)'), 
       y = bquote('Distribution alignment '*alpha['dist']*' (%)'), 
       title = 'Distribution alignment vs area alignment',
