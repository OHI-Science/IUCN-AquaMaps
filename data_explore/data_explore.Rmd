...
scatter_quadplot <- scatter_quadplot +
  ...
  ### label the quadrants:
scatter_quadplot <- scatter_quadplot +
  annotate("rect", xmin = 82, xmax = 98, ymin = 85, ymax = 91, 
           alpha = .7, fill= 'white')  + 
  annotate("rect", xmax = 24, xmin =  2, ymin = 85, ymax = 91, 
           alpha = .7, fill= "white") + 
  annotate("rect", xmin = 82, xmax = 98, ymax =  9, ymin = 15, 
           alpha = .7, fill= "white") + 
  annotate("rect", xmax = 20, xmin =  2, ymax =  9, ymin = 15, 
           alpha = .7, fill= "white") +
  annotate("text", x = 96, y = 88, hjust = 1, vjust = .5, size = 3, color = 'grey20', 
           fontface = 'bold.italic', label = "Well-aligned") + 
  annotate("text", x =  4, y = 88, hjust = 0, vjust = .5, size = 3, color = 'grey20',
           fontface = 'bold.italic', label = "Distribution-aligned") + 
  annotate("text", x = 96, y = 12, hjust = 1, vjust = .5, size = 3, color = 'grey20',
           fontface = 'bold.italic', label = "Area-aligned") + 
  annotate("text", x =  4, y = 12, hjust = 0, vjust = .5, size = 3, color = 'grey20',
