...
___NOTE:___ These images are all based on .png outputs, exported from .psd files; submit the .tif versions for publication.

### Fig. 1
<a id = 'fig1'></a>

![Taxonomic and geographic representation](figures/fig1.png)
...
![Quadrant plot and spp breakdown by quadrant](figures/fig2.png)
...
![coral area subject to depth clipping](figures/fig3.png)
...
![aquamaps edge comparison](figures/fig4.png)
...
![Change in MPA coverage](figures/fig5.png)
