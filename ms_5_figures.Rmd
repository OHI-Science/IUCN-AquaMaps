...
![coral area change due to depth clipping](figures/coral_map.png)

![coral quadmap breakdown](figures/barchart_coral_quads.png)
...
![aquamaps edge comparison](figures/am_edge_map.png)
