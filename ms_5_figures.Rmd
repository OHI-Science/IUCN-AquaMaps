...
![coral area change due to depth clipping](figures/fig3a_coral_area_plot.png)

![coral quadmap change due to depth clipping](figures/fig3b_scatter_quadmap_corals.png)

![coral quadmap breakdown](figures/fig3c_barchart_coral_quads.png)
...
![paired map comparison](figures/fig4a_violinplot_paired_maps.png)

why is the global one not showing up?:
![global full species list comparison](figures/fig4a_violinplot_ohi_global.png)
...
![Change in MPA coverage](figures/fig5_barchart_mpa_gap.png)
