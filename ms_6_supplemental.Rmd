...
<<<<<<< HEAD
species to look more closely at:
a few codes to indicate likely problems?
- DC = depth clipping; IUCN extents go beyond reasonable depth for the species
- DX = data excluded; AM excludes some observations that appear to be used for IUCN
- DP = data poor (AquaMaps acknowledges data poor status)
- NX = needs evaluation by expert; AM model likely predicts areas where species is unlikely to be found based on observed occurrences - does AM model reflect same as AM suitable habitat?

Q2:
Conus episcopatus (cones) DP, DX - d-match around Coral Triangle, but IUCN shows much more around Indian Ocean and S Pacific; also IUCN extents
Ctenochaetus binotatus - IUCN extents beyond AM
Naso vlamingii (acanthuridae) - IUCN extents beyond AM
Thalassoma purpureum (wrasses) - IUCN extents beyond AM
Porites nigrescens (corals 2) - DP - AM limited to CT; IUCN shows far greater dist, and extents
Conus ammiralis (cones) - DP - AM limited to CT, IUCN shows in Madagascar; also extents
Conus tessulatus (cones) - extents
Acropora sarmentosa (corals 1) - extents; also AM shows HI but IUCN does not?
Holothuria fuscogilva (sea cucumbers) - extents; also AM shows Mex and Central Am west coast, but IUCN does not (not available online?)
Oculina varicosa (URM-Cn-5921) (corals part 1) - lim to Caribbean; extents - this might be a good close-up map
Acanthocybium solandri (tunas/billfish) - mostly tropical by IUCN; AM shows much farther N and S

Q3:
Conus magnificus (q3 - IUCN distribution is more limited than AM distribution)
Abudefduf concolor (damselfish) - Baja for AM, southern Central Am for IUCN; maybe a good closeup map?  AM points from Baja to Peru incl Galapagos; some rejected pts from Caribbean and eastern Atlantic
Centropyge aurantonotus (angelfish) - AM shows Caribbean; IUCN shows northern South America, also maybe a good closeup map? AM points from FL to south Brazil, but no Gulf of Mexico.
Chlorurus perspicillatus (parrotfish) - IUCN shows only HI; AM shows dots all over S Pacific and near Marianas Islands
Sarda orientalis (tunas/billfish) - limited dists by IUCN
Montastraea franksi (corals 2) - DP - IUCN shows just in Caribbean; AM shows all up & down east coast of N America and S America

Q4:
Acanthurus nigroris (q4 - IUCN dist limited to HI, while AM shows all over S Pacific and CT) - AM observations all over S pacific...
Praealticus tanegasimae (blenny) - IUCN shows limited dist around Japan/Marianas; AM shows much broader through CT and W Pacific - good local map?
Stethojulis marquesensis (wrasse) - IUCN shows only small cluster of islands (Marquesas?) while AM shows much broader across S Pacific
Canthigaster leoparda (puffer) - IUCN limited spots around a couple of islands; AM shows all throughout CT
pentacheles snyderi (lobster) - DP - AM shows all over - sim to depth profiles? while IUCN shows only a couple patches - HI? S Pacific, and S Indian oceans?  AM limits to specific FAO regions, which results in odd cutoffs; also shows some data points in N Atlantic which has an odd result.
Nephropsis sulcata (lobster) - IUCN shows odd ranges, most of which don't overlap with AM
=======
>>>>>>> 2bde1ea0cf3f0e8312264b3c91b7b89420931187
