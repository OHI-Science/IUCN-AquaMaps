...
#### Possible figures
- Map of all cells
- Map of # of species per cell
- Example aquamaps (one species range)
...
JA: I think here we only need a few sentences describing how we downloaded the data and on what date. Link to the IUCN spatial data website.

IUCN data is provided as polygon shapefiles. These vectors were rasterized to the same cell resolution as AquaMaps data (0.5 degrees).
