...
- check which species are gap species and look at some maps
- check which species are 10%+ species and look at some maps
- where do these species fall georegionally? is there anything odd about their ranges?
...
<!-- * Additional filters on AquaMaps distribution criteria, such as expert review status or the number of occurrence cells used to generate the species model, can help avoid overextrapolation for data poor species. _using other attributes and variables to filter? this seems outside the scope of this paper_ -->
