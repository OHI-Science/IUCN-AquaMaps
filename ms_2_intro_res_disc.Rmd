...
n_spp_iucn   <- length(spp_iucn_maps$iucn_sid %>% unique())
n_spp_both   <- length(spp_map_pairs$iucn_sid %>% unique())
...
Conclusions:
combine datasets for increased number of species; identify data-poor species to improve confidence in range estimates
differences in methodology create significant differences in results; errors of both commission and omission
importance to conservation management - different types of errors have different implications
