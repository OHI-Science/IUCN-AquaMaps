...
#   poly_wdpa@data$IUCN_CAT %>% unique()
  ...
  prot_code_df <- data.frame('IUCN_CAT'  = c('I', 'Ia', 'Ib', 'II', 'III', 'IV', 'V', 'VI'),
                             'prot_code' = c(  1,   1,    1,    2,     3,    4,   5,    6))
...
poly_mpa2 <- poly_mpa1[order(z <- poly_mpa1@data$STATUS_YR, decreasing = TRUE), ]
