...
cell_df_klein <- combine_mpa_areas('mpa_analysis/celldata/loiczid_mpa_klein_i-iv_%s.csv', yr_list)
cell_df_all   <- combine_mpa_areas('mpa_analysis/celldata/loiczid_mpa_i-iv_%s.csv',       yr_list)
cell_df_des   <- combine_mpa_areas('mpa_analysis/celldata/loiczid_mpa_i-iv-des_%s.csv',   yr_list)
...
``` {r recreate Klein results 2014 AM data, echo = FALSE, eval = FALSE}
...
``` {r recreate Klein results 2015 AM data, echo = FALSE, eval = FALSE}
...
write_csv(mpa_klein_am2015, 'mpa_analysis/celldata/mpa_by_spp_am2015.csv')
...
dir_iucn_data <- file.path(dir_N, 'git-annex/globalprep/_raw_data/iucn_spp')
iucn_cells_file <- file.path(dir_iucn_data, 'iucn_cells_v2016.csv')
...
write_csv(iucn_spp_sum, file.path(dir_data, 'iucn_spp_summary.csv'))
...
``` {r 2015 AM data w 0 threshold, echo = FALSE, eval = FALSE}
...
``` {r plot this beast}
library(ggplot2)
source('data_explore/data_explore_fxns.R')
...
mpa_all_runs1 <- mpa_all_runs %>%
  ...
  mutate(trial = factor(trial, levels = c('iucn2015', 'am2015 (0%) + iucn2015', 'am2015 (0%)', 'am2015 (50%)', 'am2014 (50%)'))) %>%
...
barchart_mpa_gap <- ggplot(mpa_all_runs1, 
  ...
  scale_fill_manual(values = c('>10%'  = '#4dac26', 
                               ...
                               '0-2%'  = '#f1b6da',
                               'gap'   = '#d01c8b')) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 115), breaks = c(seq(0, 100, 10))) +
