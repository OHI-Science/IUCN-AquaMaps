...
![Change in MPA coverage](figures/bar2_by_taxa_all.png)
...
![Absolute change in SPP score](figures/fig3_boxplot2_abs_diff.png)
...
![Change in MPA coverage](figures/coral_area_plot.png)

![Change in MPA coverage](figures/scatter_quadmap_corals.png)
